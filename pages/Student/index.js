...
import SubjectsForm from "./Subjects";
...
export default function Admin() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <title>Student | HED Online Assessment</title>
      {/* Header */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center relative">
            ...
            <div className="flex items-center justify-end gap-2 absolute w-full">
              <span className="text-gray-600">Carl Wyne Gallardo</span>
              <div
                onClick={() => setIsProfileMenuOpen(!isProfileMenuOpen)}
                className="relative h-10 w-10 rounded-full bg-green-600 flex items-center justify-center text-white font-semibold cursor-pointer"
              >
                CG
              </div>
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        {/* Render Active Tab */}
        {activeTab === 'Subjects' && <SubjectsForm />}
